...
Load the always-applied rules. Read `AGENTS.md`, `CONTEXT.md`, `docs/ROADMAP.md`, `docs/TRACEABILITY.md`, and only other documents needed to interpret current state. Inspect `git status`, current branch/worktrees, recent commits, uncommitted diff, implementation directories, and available test evidence.
