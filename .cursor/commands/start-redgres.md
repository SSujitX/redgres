...
6. Invoke `redgres-planner` before implementation. The plan must name PRD IDs, acceptance criteria, external test seam, required reading, source-system evidence, uncertain/version-sensitive facts and how they will be verified, relevant skills, allowed paths, shared contracts, risks, docs to update, commands, and completion gate.
