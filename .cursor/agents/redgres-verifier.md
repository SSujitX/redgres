...
1. Read the originating requirement/spec, relevant ADRs, `docs/COMPATIBILITY.md`, `docs/TESTING.md`, `docs/TRACEABILITY.md`, and the full diff from its fixed point.
...
5. Verify documentation ownership from `AGENTS.md` was followed and traceability evidence matches reality; fail the completion claim when behavior/contracts changed without their canonical docs.
6. Check new APIs, symbols, flags, versions, configuration, and external behavior against pinned local evidence or authoritative primary sources; flag invented/unsupported claims and unrelated scope expansion.
