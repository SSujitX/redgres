...
|---|---|---|---|---|---|
| Redgres | `D:\code\github\Redgres` | `https://github.com/SSujitX/redgres.git` | `1b54b01` owner auth on `master` (`912b5a4` Wave 0; `553f156` specification) | AUTH-001–005 implemented; AUTH-006, UI shell, PG, Redis, OPS not started | 2026-08-23 |
