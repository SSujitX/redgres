...
|---|---|---|---|---|---|
| Redgres | `D:\code\github\Redgres` | `https://github.com/SSujitX/redgres.git` | `aff68d8` inventory UI remediations on `master` (`4aea8e5` table-list API; `b2992df` inventory UI) | AUTH-001–005, login/shell, PG-001/002, PG-007 table-list API; no table UI/rows; AUTH-006, vault, Redis, OPS not started | 2026-08-23 |
