...
|---|---|---|---|---|---|
| Redgres | `D:\code\github\Redgres` | `https://github.com/SSujitX/redgres.git` | `ce7cf8b` table-list UI on `master` (`f13296b` table-list Low fixes; `4aea8e5` table-list API) | AUTH-001–005, login/shell, PG-001/002, PG-007 table-list API+UI; no rows; AUTH-006, vault, Redis, OPS not started | 2026-08-23 |
