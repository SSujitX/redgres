...
6. Fresh owner-password reauthentication passes (or a short-lived server-side reauth grant in a future ADR). Redis ACL delete implements this as an in-handler password check on the DELETE body, not a reauth endpoint.
