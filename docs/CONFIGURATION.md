...
| `REDGRES_SQLITE_PATH` | Yes | `/var/lib/redgres/redgres.db` | Production path must be a file beneath `/var/lib/redgres`; development keeps relative and temporary paths |
