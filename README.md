...
Status: **Wave 0 foundation, owner auth, and login/shell**. PostgreSQL, Redis, and installer behavior are not implemented. The unauthenticated login route does not call `/api/v1/healthz`.
